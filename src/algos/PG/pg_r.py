...
if __name__=="__main__":
    ...
    params = {"iters": 100000, "batchsize": 20, "gamma": 0.98, "lr": 0.001, "decay" : 0.001, "ppo": True,
              ...
              "comments" : "terrain all, rails_T, only pos rew, V3, 64:64:3",
    ...
    if params["train"]:
        print("Training")
        policy = policies.RNN_BLEND_PG(env, hid_dim=64, memory_dim=24, n_temp=2, tanh=params["tanh"], to_gpu=False)
        ...
        print("Testing")
        expert = T.load('agents/Hexapod_RNN_V3_PG_E8O_pg.p') # OEB good for holes
