...
if __name__=="__main__":
    ...
    params = {"iters": 100000, "batchsize": 4, "gamma": 0.98, "lr": 0.001, "decay" : 0.003, "ppo": True,
    ...
    if params["train"]:
        print("Training")
        policy = policies.RNN_VAR_PG(env, hid_dim=128, memory_dim=128, n_temp=3, tanh=params["tanh"], to_gpu=False)
